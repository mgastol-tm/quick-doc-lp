      ...
      <section className="bg-white flex-1">
        <div className={`${container} py-12 md:py-20 flex flex-col gap-6`}>
          ...
          <p className="font-body text-base md:text-lg text-qd-text-secondary leading-[1.7] max-w-[700px]">
            Doktor Teraz to platforma telemedyczna, która umożliwia szybkie i wygodne konsultacje lekarskie online. Naszą misją jest zapewnienie każdemu pacjentowi dostępu do profesjonalnej opieki medycznej — bez kolejek, bez stresu, z dowolnego miejsca.
          </p>
          <p className="font-body text-base md:text-lg text-qd-text-secondary leading-[1.7] max-w-[700px]">
