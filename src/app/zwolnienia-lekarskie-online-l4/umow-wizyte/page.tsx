...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Umów wizytę", item: "https://doktorteraz.pl/zwolnienia-lekarskie-online-l4/umow-wizyte" },
  ],
};
  ...
  return (
    <section className="bg-qd-section-green">
      <div className={`${container} flex flex-col md:flex-row items-start gap-7 md:gap-[60px] py-10 md:py-20`}>
        ...
        {/* Checkout form */}
        <div className="w-[calc(100%+40px)] -mx-5 md:mx-0 md:w-[600px] shrink-0">
          <div className="bg-white md:rounded-2xl border-y md:border border-qd-border p-0 md:p-6 shadow-sm overflow-hidden">
