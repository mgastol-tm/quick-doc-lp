      ...
      <div className={`${container} flex flex-col md:flex-row items-center gap-7 md:gap-[60px] py-10 md:pt-20 md:pb-0`}>
        <div className="flex flex-col gap-7 md:gap-8 flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-4">
            <a href="/zwolnienia-lekarskie-l4-umow-wizyte" className="bg-qd-primary text-white font-heading text-[15px] md:text-base font-semibold px-8 py-3.5 md:py-4 rounded-full flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
      ...
      <div className={`${container} flex flex-col items-center gap-8 md:gap-14 py-12 md:py-20`}>
        ...
        <div className="w-full max-w-[520px] border border-qd-border rounded-2xl bg-white overflow-hidden">
          ...
          <div className="px-6 pb-6 md:px-8 md:pb-8">
            <a href="/zwolnienia-lekarskie-l4-umow-wizyte" className="block w-full bg-qd-primary text-white font-heading text-[15px] md:text-base font-semibold py-3.5 md:py-4 rounded-full text-center hover:opacity-90 transition-opacity">
